...
#        db.delete_table('store_queue_site')
        ...
        # Adding unique constraint on 'Address', fields ['zip_code', 'address']
        db.create_unique('store_address', ['zip_code', 'address'])


        # Changing field 'Invoice.needed_by'
        db.alter_column('store_invoice', 'needed_by', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Invoice.ship_date'
        db.alter_column('store_invoice', 'ship_date', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Removing unique constraint on 'Address', fields ['zip_code', 'address']
        db.delete_unique('store_address', ['zip_code', 'address'])

        # Adding model 'Queue'
        db.create_table('store_queue', (
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='store_queue_updated_by_related', to=orm['auth.User'])),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='store_queue_user_related', to=orm['auth.User'])),
        ...
        # Changing field 'Invoice.needed_by'
        db.alter_column('store_invoice', 'needed_by', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Invoice.ship_date'
        db.alter_column('store_invoice', 'ship_date', self.gf('django.db.models.fields.DateTimeField')())
