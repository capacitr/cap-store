...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('store_address', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Address.email'
        db.add_column('store_address', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Invoice.invoice_number'
        db.add_column('store_invoice', 'invoice_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Invoice.tax_discount'
        db.add_column('store_invoice', 'tax_discount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'LineItem.row_color'
        db.add_column('store_lineitem', 'row_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Customer.business_name'
        db.add_column('store_customer', 'business_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('store_address', 'phone')

        # Deleting field 'Address.email'
        db.delete_column('store_address', 'email')

        # Deleting field 'Invoice.invoice_number'
        db.delete_column('store_invoice', 'invoice_number')

        # Deleting field 'Invoice.tax_discount'
        db.delete_column('store_invoice', 'tax_discount')

        # Deleting field 'LineItem.row_color'
        db.delete_column('store_lineitem', 'row_color')

        # Deleting field 'Customer.business_name'
        db.delete_column('store_customer', 'business_name')
