...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.order'
        db.alter_column('store_invoice', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['store.Order'], null=True))

    def backwards(self, orm):

        # Changing field 'Invoice.order'
        db.alter_column('store_invoice', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['store.Order']))
    ...
    models = {
        ...
        'store.invoice': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['store.Order']", 'null': 'True'}),
