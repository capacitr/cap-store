...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('store_address', 'address', self.gf('django.db.models.fields.TextField')(max_length=355))

    def backwards(self, orm):

        # Changing field 'Address.address'
        db.alter_column('store_address', 'address', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'store.address': {
            ...
            'address': ('django.db.models.fields.TextField', [], {'max_length': '355'}),
